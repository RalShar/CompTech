...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->num_rows > 0) {
        ...
        $update_stmt->bind_param("iis", $new_count, $user_id, $id_product); // Привязываем параметры
        ...
        $insert_stmt->bind_param("isi", $user_id, $id_product, $count); // Привязываем параметры
